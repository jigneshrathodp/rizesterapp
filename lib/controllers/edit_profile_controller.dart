    ...
    if (formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (result.status == true) {
          ...
          await GlobalProfileController.to.refreshProfileData();
